  ...
  return (
    <main>
      ...
      <div className="container mx-auto relative flex items-center justify-center">
        <div className="absolute top-[-50px] z-30 bg-white max-w-[800px] w-full rounded-full px-10 py-5 grid grid-cols-4 shadow-lg">
          <div className="space-y-2">
            <div className="text-[#989898] flex items-center">
              City Street <ChevronDown className="ml-1" size={20} />
            </div>
            <div className="text-[#228B22] font-bold">Panjer</div>
          </div>
          <div className="space-y-2">
            <div className="text-[#989898]  flex items-center">
              Tipologi of rent <ChevronDown className="ml-1" size={20} />
            </div>
            <div className="text-[#228B22] font-bold">Vila</div>
          </div>
          <div className="space-y-2">
            <div className="text-[#989898] flex items-center">
              Price <ChevronDown className="ml-1" size={20} />
            </div>
            <div className="text-[#228B22] font-bold">Rp. 1.000.000</div>
          </div>
          <button className="bg-[#228B22] rounded-tr-full rounded-br-full text-white flex items-center px-5 hover:bg-[#207521] transition-all duration-150">
      ...
      <div className="pb-20">
        <div className="container mx-auto grid md:grid-cols-2 gap-20">
          ...
          <div className="space-y-10 flex flex-col justify-between">
            <h2 className="text-5xl max-w-[500px] text-[#228B22] font-semibold">
